...
export DOCKERHUB_UNAME=harrymiranda
...
sleep 10 
docker exec depression-screening-app-api-1 python /src/manage.py makemigrations 
docker exec depression-screening-app-api-1 python /src/manage.py migrate